...
description: "Situační report vypuknutí Bundibugyo viru v DRC a Ugandě 2026. Zdroj: IMG AV ČR / UJEP. Verze v80, ověřeno 2026-09-02."
...
update_freq: "Průběžně (aktivní vypuknutí) · Dataset verze v80 · 2026-09-02"
---
...
**6 100 potvrzených případů a 2 950 úmrtí v DRK k 30. srpnu**Národní SitRep 108 uvádí také 1 383 uzdravených, 814 pacientů v izolaci nebo léčebných centrech a 60 zasažených zdravotních zón v šesti provinciích.

**WHO AFRO: trvající přenos, vysoký počet úmrtí a geografická expanze**Report 16 se stavem k 30. 8. uvádí 6 100 případů, 2 950 úmrtí a nárůst počtu zasažených zdravotních zón z 57 na 60 během týdne.
...
**Druhé největší ebolové ohnisko celkově a nejsmrtelnější v historii DRK**Současných 6 100 případů a 2 950 úmrtí překonává epidemii Severní Kivu/Ituri 2018–2020 (3 481 případů, 2 299 úmrtí). Více případů i úmrtí měla pouze epidemie v západní Africe 2013–2016.
...
**Evropa: pravděpodobnost infekce zůstává velmi nízká**ECDC na stránce aktualizované 1. 9. své hodnocení pro obyvatele EU/EHP nezměnilo a převzalo údaje SitRepu 108 se stavem k 30. 8.

## Aktuální informace k 2. září 2026

Nejnovější údaje uvádíme podle jednotlivých zdrojů se stavem k datu a s rozlišením jejich důkazní síly. Národní SitRep 108 uvádí pro DRK k 30. srpnu 6 100 potvrzených případů, 2 950 potvrzených úmrtí, 1 383 uzdravených a 814 pacientů v izolaci nebo léčebných centrech. Denní souhrn WHO z 1. září používá pro DRK stejný stav k 30. srpnu; při zachování starších dat pro Ugandu a Francii uvádí mezinárodně 6 121 potvrzených případů, 2 952 potvrzených úmrtí a 1 402 uzdravených. Země mají rozdílný stav k datu, proto nejde o součet k jedinému dni.

SitRep 108 uvádí 60 zasažených zdravotních zón ze 151 v šesti provinciích. WHO AFRO v reportu 16 označuje Gangu v provincii Bas-Uélé a Bienu s Manguredjipou v Severním Kivu za nově zasažené od předchozího týdenního reportu; počet zón se zvýšil z 57 na 60.

SitRep 108 přímo hlásí za 30. srpna 59 nově potvrzených případů a 39 nově hlášených úmrtí: 19 komunitních a 20 v léčebných centrech. Předchozí SitRep 107 hlásil za 29. srpna 96 případů a 49 úmrtí. U úmrtí přebíráme součet výslovně uvedených složek, nikoli pouhý rozdíl kumulativních údajů. Denní hodnoty nevykládáme jako data vzniku infekcí nebo úmrtí.
...
V Kisangani bylo 27. srpna zahájeno očkování zdravotníků a dalších pracovníků v první linii vakcínou Ervebo; zahájení přímo potvrzuje WHO DON 616. Aktualizované doporučení WHO zveřejněné 1. září hodnotí důkazy o účinnosti Erveba proti BDBV jako nedostatečné pro programové použití. Jako hlavní zásadu doporučuje použití v rámci výzkumného protokolu a za nejspolehlivější cestu k odpovědi považuje dobře navrženou randomizovanou studii okruhové vakcinace. Pokud vhodné klinické hodnocení nebo studie účinnosti nejsou proveditelné, připouští WHO výjimečné použití mimo schválenou indikaci (off-label) a mimo výzkumný protokol za podmínky robustních systematických očkovacích záznamů, které umožní identifikovat příjemce a propojit záznamy s následnými expozicemi a zdravotními výsledky. Ochrana lidí proti BDBV zůstává neznámá, očkování není regulačním schválením pro BDBV a nenahrazuje ostatní opatření. Tři vakcíny a tři léčebné přípravky jsou podle vystoupení WHO z 1. září v klinických studiích. ECDC na stránce aktualizované 1. září dál hodnotí pravděpodobnost infekce pro osoby žijící v EU/EHP jako velmi nízkou.

| Zdroj | Zveřejnění a údaje ke dni | Hlavní údaj | Jak jej číst |
| --- | --- | --- | --- |
| DRK INSP / COUSP SitRep 108 | Údaje k 30. 8.; zveřejněno 31. 8.; ověřeno 2. 9. | 6 100 potvrzených případů, 2 950 potvrzených úmrtí, 1 383 uzdravených, 814 pacientů v izolaci nebo CTE, 86,3 % kontaktů ve sledování a průběžná smrtnost 48,4 %. | Nejnovější primární celostátní stav. Za 30. 8. přímo hlásí 59 případů a 39 úmrtí (19 komunitních + 20 v CTE); nejde automaticky o data vzniku infekcí nebo úmrtí. |
| WHO AFRO Weekly External Situation Report 16 | Údaje k 30. 8.; ověřeno 2. 9. | 6 100 potvrzených případů a 2 950 potvrzených úmrtí; proti reportu 15 o 516 případů a 270 úmrtí více. | WHO popisuje trvající přenos, vysoký počet úmrtí a pokračující geografickou expanzi. Odkaz ke stažení vracel starší report 12, proto přebíráme pouze výslovný oficiální souhrn na stránce WHO AFRO. |
| WHO AFRO: 100 dnů od vyhlášení ohniska | Zveřejněno 24. 8.; ověřeno 2. 9. | WHO označuje událost za nejrychleji rostoucí ebolové ohnisko v historii DRK, uvádí přibližně 90 potvrzených případů denně za první tři měsíce a varuje, že přenos předbíhá kontrolní úsilí. | Jde o trendové a operační hodnocení; číselně je novější SitRep 108. |
| DRK INSP / WHO AFRO: geografické rozložení | Stav k 30. 8. | Ohnisko zasahuje šest provincií a 60 ze 151 zdravotních zón. | WHO AFRO uvádí jako nově zasažené od reportu 15 Gangu v Bas-Uélé a Bienu s Manguredjipou v Severním Kivu. |
| WHO denní epidemiologická aktualizace | Aktualizace 20260901; DRK k 30. 8., Uganda k 21. 7. a Francie k 6. 7. | 6 121 potvrzených případů, 2 952 potvrzených úmrtí a 1 402 uzdravených ve třech zemích. | Řádek Total souhlasí se součtem řádků zemí. Země však mají rozdílný stav k datu, takže údaj není stavem všech tří zemí k jedinému dni. |
...
| WHO Rapid Risk Assessment v4 | Hodnocení datováno 14. 8.; zveřejněno 20. 8.; ověřeno 2. 9. | Velmi vysoké riziko v DRK, vysoké ve státech se společnou pozemní hranicí s DRK a nízké pro zbytek Afriky i globálně. | Jde o aktuální rámec rizika, ne o nejnovější číselný stav. WHO uvádí střední důvěru v podklady pro DRK, sousední státy a zbytek Afriky a vysokou pro globální úroveň. |
...
| 30.–31. 8. 2026 | SitRepy 107–108 posouvají stav DRK k 30. srpnu na 6 100 potvrzených případů a 2 950 potvrzených úmrtí. | SitRep 108 uvádí 1 383 uzdravených, 814 pacientů v izolaci nebo léčebných centrech a 60 zasažených zón v šesti provinciích. Proti v78 jde o +155 případů a +88 úmrtí, bez nové zasažené zóny. | DRK INSP / COUSP |
...
| 29. 6.–2. 9. 2026 | Pathoplexus obsahuje databázové záznamy pro virus Bundibugyo; jejich počet se proti předchozí publikované verzi nezměnil. | Při ověření 2. 9. agregace LAPIS ukazovala 753 verzovaných databázových položek pro označení ohniska Bdbv-2026: 731 z DRK, 20 z Ugandy a 2 z Německa. Jejich počet není počtem klinických případů, počtem genomů v jedné analýze ani důkazem nebezpečné mutace. | Pathoplexus |
