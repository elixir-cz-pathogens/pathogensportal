...
update_freq: "Průběžně (aktivní vypuknutí) · Dataset verze v82 · 2026-09-04"
---
...
**6 250 potvrzených případů a 3 039 úmrtí v DRK k 1. září**Národní SitRep 110 uvádí také 1 439 uzdravených, 869 pacientů v izolaci nebo léčebných centrech a 60 zasažených zdravotních zón v šesti provinciích.

**WHO AFRO: trvající přenos, vysoký počet úmrtí a geografická expanze**SitRep 110 za 1. 9. přímo hlásí 64 nově potvrzených případů a 32 nově hlášených úmrtí. WHO AFRO report 16 nadále popisuje trvající přenos a geografickou expanzi.
...
**Druhé největší ebolové ohnisko celkově a nejsmrtelnější v historii DRK**Současných 6 250 případů a 3 039 úmrtí překonává epidemii Severní Kivu/Ituri 2018–2020 (3 481 případů, 2 299 úmrtí). Více případů i úmrtí měla pouze epidemie v západní Africe 2013–2016.
...
**Evropa: pravděpodobnost infekce zůstává velmi nízká**ECDC na stránce aktualizované 3. 9. své hodnocení pro obyvatele EU/EHP nezměnilo a převzalo údaje SitRepu 110 se stavem k 1. 9.

## Aktuální informace k 4. září 2026

Nejnovější údaje uvádíme podle jednotlivých zdrojů se stavem k datu a s rozlišením jejich důkazní síly. Národní SitRep 110 uvádí pro DRK k 1. září 6 250 potvrzených případů, 3 039 potvrzených úmrtí, 1 439 uzdravených a 869 pacientů v izolaci nebo léčebných centrech. Denní souhrn WHO ze 3. září používá pro DRK stejný stav k 1. září; při zachování starších dat pro Ugandu a Francii uvádí mezinárodně 6 271 potvrzených případů, 3 041 potvrzených úmrtí a 1 458 uzdravených. Země mají rozdílný stav k datu, proto nejde o součet k jedinému dni.

SitRep 110 uvádí 60 zasažených zdravotních zón ze 151 v šesti provinciích a nehlásí novou zasaženou zónu. WHO AFRO v reportu 16 označuje Gangu v provincii Bas-Uélé a Bienu s Manguredjipou v Severním Kivu za nově zasažené od předchozího týdenního reportu; počet zón se zvýšil z 57 na 60.

SitRep 110 přímo hlásí za 1. září 64 nově potvrzených případů a 32 nově hlášených úmrtí: 25 komunitních a 7 v léčebných centrech. Předchozí SitRep 109 hlásil za 31. srpna 86 případů a 57 úmrtí. U úmrtí přebíráme součet výslovně uvedených složek, nikoli pouhý rozdíl kumulativních údajů. Denní hodnoty nevykládáme jako data vzniku infekcí nebo úmrtí.
...
V Kisangani bylo 27. srpna zahájeno očkování zdravotníků a dalších pracovníků v první linii vakcínou Ervebo; zahájení přímo potvrzuje WHO DON 616. Aktualizované doporučení WHO zveřejněné 1. září hodnotí důkazy o účinnosti Erveba proti BDBV jako nedostatečné pro programové použití. Jako hlavní zásadu doporučuje použití v rámci výzkumného protokolu a za nejspolehlivější cestu k odpovědi považuje dobře navrženou randomizovanou studii okruhové vakcinace. Pokud vhodné klinické hodnocení nebo studie účinnosti nejsou proveditelné, připouští WHO výjimečné použití mimo schválenou indikaci (off-label) a mimo výzkumný protokol za podmínky robustních systematických očkovacích záznamů, které umožní identifikovat příjemce a propojit záznamy s následnými expozicemi a zdravotními výsledky. Ochrana lidí proti BDBV zůstává neznámá, očkování není regulačním schválením pro BDBV a nenahrazuje ostatní opatření. Tři vakcíny a tři léčebné přípravky jsou podle vystoupení WHO z 1. září v klinických studiích. ECDC na stránce aktualizované 3. září dál hodnotí pravděpodobnost infekce pro osoby žijící v EU/EHP jako velmi nízkou.

| Zdroj | Zveřejnění a údaje ke dni | Hlavní údaj | Jak jej číst |
| --- | --- | --- | --- |
| DRK INSP / COUSP SitRep 110 | Údaje k 1. 9.; PDF datováno 2. 9.; zveřejněno 3. 9.; ověřeno 4. 9. | 6 250 potvrzených případů, 3 039 potvrzených úmrtí, 1 439 uzdravených, 869 pacientů v izolaci nebo CTE, 89,0 % kontaktů ve sledování a průběžná smrtnost 48,6 %. | Nejnovější primární celostátní stav. Za 1. 9. přímo hlásí 64 případů a 32 úmrtí (25 komunitních + 7 v CTE); nejde automaticky o data vzniku infekcí nebo úmrtí. |
| WHO AFRO Weekly External Situation Report 16 | Údaje k 30. 8.; ověřeno 4. 9. | 6 100 potvrzených případů a 2 950 potvrzených úmrtí; proti reportu 15 o 516 případů a 270 úmrtí více. | WHO popisuje trvající přenos, vysoký počet úmrtí a pokračující geografickou expanzi. Odkaz ke stažení vracel starší report 12, proto přebíráme pouze výslovný oficiální souhrn na stránce WHO AFRO. |
| WHO AFRO: 100 dnů od vyhlášení ohniska | Zveřejněno 24. 8.; ověřeno 4. 9. | WHO označuje událost za nejrychleji rostoucí ebolové ohnisko v historii DRK, uvádí přibližně 90 potvrzených případů denně za první tři měsíce a varuje, že přenos předbíhá kontrolní úsilí. | Jde o trendové a operační hodnocení; číselně je novější SitRep 110. |
| DRK INSP / WHO AFRO: geografické rozložení | Stav k 1. 9. | Ohnisko zasahuje šest provincií a 60 ze 151 zdravotních zón. | WHO AFRO uvádí jako nově zasažené od reportu 15 Gangu v Bas-Uélé a Bienu s Manguredjipou v Severním Kivu; SitRep 110 nehlásí novou zónu. |
| WHO denní epidemiologická aktualizace | Aktualizace 20260903; DRK k 1. 9., Uganda k 21. 7. a Francie k 6. 7. | 6 271 potvrzených případů, 3 041 potvrzených úmrtí a 1 458 uzdravených ve třech zemích. | Řádek Total souhlasí se součtem řádků zemí. Země však mají rozdílný stav k datu, takže údaj není stavem všech tří zemí k jedinému dni. |
...
| WHO Rapid Risk Assessment v4 | Hodnocení datováno 14. 8.; zveřejněno 20. 8.; ověřeno 4. 9. | Velmi vysoké riziko v DRK, vysoké ve státech se společnou pozemní hranicí s DRK a nízké pro zbytek Afriky i globálně. | Jde o aktuální rámec rizika, ne o nejnovější číselný stav. WHO uvádí střední důvěru v podklady pro DRK, sousední státy a zbytek Afriky a vysokou pro globální úroveň. |
...
| 1.–3. 9. 2026 | SitRep 110 posouvá stav DRK k 1. září na 6 250 potvrzených případů a 3 039 potvrzených úmrtí. | Uvádí 1 439 uzdravených, 869 pacientů v izolaci nebo léčebných centrech a 60 zasažených zón v šesti provinciích. Za 1. září přímo hlásí 64 případů a 32 úmrtí, bez nové zasažené zóny. | DRK INSP / COUSP |
...
| 29. 6.–4. 9. 2026 | Pathoplexus obsahuje databázové záznamy pro virus Bundibugyo; jejich počet se proti předchozí publikované verzi nezměnil. | Při ověření 4. 9. agregace LAPIS ukazovala 753 verzovaných databázových položek pro označení ohniska Bdbv-2026: 731 z DRK, 20 z Ugandy a 2 z Německa. Jejich počet není počtem klinických případů, počtem genomů v jedné analýze ani důkazem nebezpečné mutace. | Pathoplexus |
