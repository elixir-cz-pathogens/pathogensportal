...
description: "Situační report vypuknutí Bundibugyo viru v DRC a Ugandě 2026. Zdroj: IMG AV ČR / UJEP. Verze v81, ověřeno 2026-09-03."
...
update_freq: "Průběžně (aktivní vypuknutí) · Dataset verze v81 · 2026-09-03"
---

<div class="d-flex flex-wrap gap-1 mb-4" role="navigation" aria-label="Sekce situačního reportu">
  <a href="/dashboards/ebola-bundibugyo-2026/" class="btn btn-sm btn-outline-secondary me-1 mb-1 active">Aktuální stav</a>
...
**6 186 potvrzených případů a 3 007 úmrtí v DRK k 31. srpnu**Národní SitRep 109 uvádí také 1 409 uzdravených, 830 pacientů v izolaci nebo léčebných centrech a 60 zasažených zdravotních zón v šesti provinciích.

**WHO AFRO: trvající přenos, vysoký počet úmrtí a geografická expanze**SitRep 109 za 31. 8. přímo hlásí 86 nově potvrzených případů a 57 nově hlášených úmrtí. WHO AFRO report 16 nadále popisuje trvající přenos a geografickou expanzi.

**WHO: Ervebo proti BDBV přednostně ve výzkumu**Hlavním doporučením je použití v rámci výzkumného protokolu. Úplný dokument připouští úzkou výjimku, nelze-li provést vhodnou studii a jsou-li vedeny robustní dohledatelné záznamy. Ochrana lidí zůstává neznámá.

**PHEIC pokračuje: WHO zveřejnila úplnou zprávu**Úplná zpráva z druhého jednání nouzového výboru zveřejněná 28. 8. potvrzuje trvání PHEIC. Pro ostatní státy WHO doporučuje posílit připravenost a informovat cestující, nikoli pozastavit lety nebo odepřít vstup.

**Druhé největší ebolové ohnisko celkově a nejsmrtelnější v historii DRK**Současných 6 186 případů a 3 007 úmrtí překonává epidemii Severní Kivu/Ituri 2018–2020 (3 481 případů, 2 299 úmrtí). Více případů i úmrtí měla pouze epidemie v západní Africe 2013–2016.

**60 zasažených zdravotních zón v šesti provinciích**WHO AFRO uvádí jako nově zasažené od předchozího týdenního reportu Gangu, Bienu a Manguredjipu. Nejde o novou provincii ani nový stát.

**WHO formálně potvrdila konec ohniska v Ugandě**Po 42 dnech bez nového potvrzeného případu WHO AFRO 27. 8. oznámila konec ohniska. Uganda eviduje 20 potvrzených případů, 18 uzdravených a 2 potvrzená úmrtí; riziko opětovného zavlečení z DRK trvá.

**Evropa: pravděpodobnost infekce zůstává velmi nízká**ECDC na stránce aktualizované 2. 9. své hodnocení pro obyvatele EU/EHP nezměnilo a převzalo údaje SitRepu 109 se stavem k 31. 8.

## Aktuální informace k 3. září 2026

Nejnovější údaje uvádíme podle jednotlivých zdrojů se stavem k datu a s rozlišením jejich důkazní síly. Národní SitRep 109 uvádí pro DRK k 31. srpnu 6 186 potvrzených případů, 3 007 potvrzených úmrtí, 1 409 uzdravených a 830 pacientů v izolaci nebo léčebných centrech. Denní souhrn WHO z 2. září používá pro DRK stejný stav k 31. srpnu; při zachování starších dat pro Ugandu a Francii uvádí mezinárodně 6 207 potvrzených případů, 3 009 potvrzených úmrtí a 1 428 uzdravených. Země mají rozdílný stav k datu, proto nejde o součet k jedinému dni.

SitRep 109 uvádí 60 zasažených zdravotních zón ze 151 v šesti provinciích a nehlásí novou zasaženou zónu. WHO AFRO v reportu 16 označuje Gangu v provincii Bas-Uélé a Bienu s Manguredjipou v Severním Kivu za nově zasažené od předchozího týdenního reportu; počet zón se zvýšil z 57 na 60.

SitRep 109 přímo hlásí za 31. srpna 86 nově potvrzených případů a 57 nově hlášených úmrtí: 43 komunitních a 14 v léčebných centrech. Předchozí SitRep 108 hlásil za 30. srpna 59 případů a 39 úmrtí. U úmrtí přebíráme součet výslovně uvedených složek, nikoli pouhý rozdíl kumulativních údajů. Denní hodnoty nevykládáme jako data vzniku infekcí nebo úmrtí.
...
WHO AFRO v reportu 16 se stavem k 30. srpnu uvádí trvající přenos, vysoký počet úmrtí a pokračující geografickou expanzi; od reportu 15 přibylo 516 případů a 270 úmrtí. Přenos přetrvává v Ituri a zesiluje v Severním Kivu a Haut-Uélé. Odkaz WHO označený jako stažení reportu 16 při ověření vedl ke staršímu reportu 12, proto pro tato tvrzení používáme pouze výslovný oficiální souhrn na stránce WHO AFRO. Generální ředitel WHO 1. září označil ohnisko za druhé největší a nejrychleji se šířící zaznamenané ebolové ohnisko a upozornil na komunitní úmrtí, nebezpečné pohřby a neznámé řetězce přenosu. Pathoplexus/LAPIS při ověření 3. září obsahoval 753 verzovaných databázových položek pro Bdbv-2026: 731 z DRK, 20 z Ugandy a 2 z Německa, stejně jako v předchozí publikované verzi. Databázové položky nejsou klinické případy; jejich počet není počtem genomů v jedné analýze ani důkazem změny vlastností viru.
...
V Kisangani bylo 27. srpna zahájeno očkování zdravotníků a dalších pracovníků v první linii vakcínou Ervebo; zahájení přímo potvrzuje WHO DON 616. Aktualizované doporučení WHO zveřejněné 1. září hodnotí důkazy o účinnosti Erveba proti BDBV jako nedostatečné pro programové použití. Jako hlavní zásadu doporučuje použití v rámci výzkumného protokolu a za nejspolehlivější cestu k odpovědi považuje dobře navrženou randomizovanou studii okruhové vakcinace. Pokud vhodné klinické hodnocení nebo studie účinnosti nejsou proveditelné, připouští WHO výjimečné použití mimo schválenou indikaci (off-label) a mimo výzkumný protokol za podmínky robustních systematických očkovacích záznamů, které umožní identifikovat příjemce a propojit záznamy s následnými expozicemi a zdravotními výsledky. Ochrana lidí proti BDBV zůstává neznámá, očkování není regulačním schválením pro BDBV a nenahrazuje ostatní opatření. Tři vakcíny a tři léčebné přípravky jsou podle vystoupení WHO z 1. září v klinických studiích. ECDC na stránce aktualizované 2. září dál hodnotí pravděpodobnost infekce pro osoby žijící v EU/EHP jako velmi nízkou.

| Zdroj | Zveřejnění a údaje ke dni | Hlavní údaj | Jak jej číst |
| --- | --- | --- | --- |
| DRK INSP / COUSP SitRep 109 | Údaje k 31. 8.; PDF datováno 1. 9.; zveřejněno 2. 9.; ověřeno 3. 9. | 6 186 potvrzených případů, 3 007 potvrzených úmrtí, 1 409 uzdravených, 830 pacientů v izolaci nebo CTE, 88,0 % kontaktů ve sledování a průběžná smrtnost 48,6 %. | Nejnovější primární celostátní stav. Za 31. 8. přímo hlásí 86 případů a 57 úmrtí (43 komunitních + 14 v CTE); nejde automaticky o data vzniku infekcí nebo úmrtí. |
| WHO AFRO Weekly External Situation Report 16 | Údaje k 30. 8.; ověřeno 3. 9. | 6 100 potvrzených případů a 2 950 potvrzených úmrtí; proti reportu 15 o 516 případů a 270 úmrtí více. | WHO popisuje trvající přenos, vysoký počet úmrtí a pokračující geografickou expanzi. Odkaz ke stažení vracel starší report 12, proto přebíráme pouze výslovný oficiální souhrn na stránce WHO AFRO. |
| WHO AFRO: 100 dnů od vyhlášení ohniska | Zveřejněno 24. 8.; ověřeno 3. 9. | WHO označuje událost za nejrychleji rostoucí ebolové ohnisko v historii DRK, uvádí přibližně 90 potvrzených případů denně za první tři měsíce a varuje, že přenos předbíhá kontrolní úsilí. | Jde o trendové a operační hodnocení; číselně je novější SitRep 109. |
| DRK INSP / WHO AFRO: geografické rozložení | Stav k 31. 8. | Ohnisko zasahuje šest provincií a 60 ze 151 zdravotních zón. | WHO AFRO uvádí jako nově zasažené od reportu 15 Gangu v Bas-Uélé a Bienu s Manguredjipou v Severním Kivu; SitRep 109 nehlásí novou zónu. |
| WHO denní epidemiologická aktualizace | Aktualizace 20260902; DRK k 31. 8., Uganda k 21. 7. a Francie k 6. 7. | 6 207 potvrzených případů, 3 009 potvrzených úmrtí a 1 428 uzdravených ve třech zemích. | Řádek Total souhlasí se součtem řádků zemí. Země však mají rozdílný stav k datu, takže údaj není stavem všech tří zemí k jedinému dni. |
...
| WHO Rapid Risk Assessment v4 | Hodnocení datováno 14. 8.; zveřejněno 20. 8.; ověřeno 3. 9. | Velmi vysoké riziko v DRK, vysoké ve státech se společnou pozemní hranicí s DRK a nízké pro zbytek Afriky i globálně. | Jde o aktuální rámec rizika, ne o nejnovější číselný stav. WHO uvádí střední důvěru v podklady pro DRK, sousední státy a zbytek Afriky a vysokou pro globální úroveň. |
...
| WHO: aktualizované doporučení k Ervebu proti BDBV | Dokument datován 31. 8.; zveřejněn 1. 9. | Důkazy jsou nedostatečné pro programové použití. Hlavním doporučením je použití v rámci výzkumného protokolu; úzká výjimka mimo něj platí jen tehdy, nelze-li provést vhodnou studii a existují-li robustní dohledatelné záznamy. | Účinnost u lidí zůstává neznámá. Doporučení není schválením pro BDBV a očkování nenahrazuje základní opatření. |
...
| WHO AFRO: operační stav reakce | Prohlášení zveřejněné 17. 7.; jeho číselný příklad je výslovně stav k 16. 7. | WHO uvádí, že přes 80 % nových případů bylo zachyceno mimo známé seznamy kontaktů, přibližně dvě třetiny úmrtí nastaly v komunitách a zařízení v nejvíce zasažených oblastech jsou na hranici kapacity nebo blízko ní. | Operační kontext používáme odděleně; starší počty případů z prohlášení nenahrazují report 16 ani vystoupení WHO z 1. 9. |
...
Krátký přehled ponechává jen události, které mění interpretaci ohniska. Denní dílčí čísla a podrobné změny jsou uvedené [ve zdrojích](/dashboards/ebola-zdroje/).

| Datum události | Co se stalo | Proč je to důležité | Hlavní zdroj |
| --- | --- | --- | --- |
| 1. 9. 2026 | WHO zveřejňuje aktualizované doporučení k Ervebu a vystoupení generálního ředitele pro členské státy. | Hlavním doporučením je použití Erveba proti BDBV v rámci výzkumného protokolu; úzká výjimka vyžaduje neproveditelnost vhodné studie a robustní dohledatelné záznamy. Ochrana lidí zůstává neznámá. | WHO |
...
| 31. 8.–2. 9. 2026 | SitRep 109 posouvá stav DRK k 31. srpnu na 6 186 potvrzených případů a 3 007 potvrzených úmrtí. | Uvádí 1 409 uzdravených, 830 pacientů v izolaci nebo léčebných centrech a 60 zasažených zón v šesti provinciích. Za 31. srpna přímo hlásí 86 případů a 57 úmrtí, bez nové zasažené zóny. | DRK INSP / COUSP |
...
| 29. 6.–3. 9. 2026 | Pathoplexus obsahuje databázové záznamy pro virus Bundibugyo; jejich počet se proti předchozí publikované verzi nezměnil. | Při ověření 3. 9. agregace LAPIS ukazovala 753 verzovaných databázových položek pro označení ohniska Bdbv-2026: 731 z DRK, 20 z Ugandy a 2 z Německa. Jejich počet není počtem klinických případů, počtem genomů v jedné analýze ani důkazem nebezpečné mutace. | Pathoplexus |
...
Podrobněji viz [Dezinformace a zavádějící tvrzení](/dashboards/ebola-dezinformace/).
...
Verze
:   v81 · ověřeno 3. 9. 2026

Autoři
:   [Jan Pačes](https://orcid.org/0000-0003-3059-6127) a [Michaela Liegertová](https://orcid.org/0000-0003-3858-856X)

Původ informací
:   [Datované primární a odborné zdroje](/dashboards/ebola-zdroje/)

Licence
:   [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) pro původní obsah webu

[Jak citovat](https://titan.img.cas.cz/ebola/CITATION.cff)
[Data ke grafu](/dashboards/ebola-graf-vyvoj/#fair-data)

Strojově čitelná vrstva: [JSON-LD metadata webu](https://titan.img.cas.cz/ebola/metadata/index.jsonld). Není-li uvedeno jinak, původní text, grafy vytvořené pro tento web, kurace dat a strojově čitelná metadata jsou zveřejněny pod licencí [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/). Licence se nevztahuje na loga, ochranné známky ani na citované nebo odkazované materiály třetích stran; pro ně platí podmínky jejich původních držitelů práv.

## Kam dál

<div class="row g-2 my-3">
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-cesko/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Český kontext</div>
        <div class="text-muted" style="font-size:0.75rem">Riziko pro veřejnost, FN Bulovka, cestovatelé, zdravotníci a české oficiální i podpůrné zdroje na jednom místě.</div>
      </div>
    </a>
  </div>
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-virus/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Ebolaviry</div>
        <div class="text-muted" style="font-size:0.75rem">Obecně ebolaviry, rozdíl mezi virem Ebola a virem Bundibugyo, přenos, diagnostika a sekvenování.</div>
      </div>
    </a>
  </div>
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-lecba-vakciny/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Léčba a vakcíny</div>
        <div class="text-muted" style="font-size:0.75rem">Co je schválené pro virus Ebola, co zatím chybí pro Bundibugyo a co se zkouší.</div>
      </div>
    </a>
  </div>
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-predchozi-epidemie/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Minulé epidemie</div>
        <div class="text-muted" style="font-size:0.75rem">Západní Afrika 2014–2016 a Severní Kivu/Ituri 2018–2020 jako hlavní poučení pro rok 2026.</div>
      </div>
    </a>
  </div>
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-dezinformace/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Dezinformace</div>
        <div class="text-muted" style="font-size:0.75rem">Opakující se narativy, český kontext a rychlé odpovědi k FN Bulovka, Těchonínu a Berlínu.</div>
      </div>
    </a>
  </div>
  <div class="col-6 col-md-3">
    <a href="/dashboards/ebola-zdroje/" class="card h-100 text-decoration-none text-dark">
      <div class="card-body p-3">
        <div class="fw-semibold small">Zdroje</div>
        <div class="text-muted" style="font-size:0.75rem">Oficiální, české, odborné, mediální a další zdroje rozdělené podle typu.</div>
      </div>
    </a>
  </div>
</div>