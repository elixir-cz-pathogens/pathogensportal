...
<div class="d-flex flex-wrap gap-1 mb-4" role="navigation" aria-label="Sekce situačního reportu">
  ...
  <a href="/dashboards/ebola-cesko/" class="btn btn-sm btn-outline-secondary me-1 mb-1 active">Český kontext</a>
...
| Situace | Co víme k 2. 9. 2026 | Interpretace |
| --- | --- | --- |
...
| Francie | WHO denní tabulka 20260901 uvádí Francii jako 1 potvrzený importovaný případ k 6. červenci a vede jej jako uzdravený. | Importovaný potvrzený případ v Evropě, ne komunitní přenos a ne český případ. Pro ČR je důležitý hlavně jako připomínka připravenosti zdravotnických systémů a přesného rozlišování mezi importem a komunitním přenosem. |
...
Riziko pro veřejnost v České republice zůstává velmi nízké. ČR není v sousedství postižených států a ebola se nešíří vzduchem jako chřipka nebo covid-19. ECDC na stránce aktualizované 1. září a ověřené 2. září dál hodnotí pravděpodobnost infekce pro osoby žijící v EU/EHP jako velmi nízkou; toto hodnocení nemění ani české laboratorně vyloučené podezření, ani řízená zdravotnická evakuace pacienta nakaženého v DRK do Frankfurtu.
...
Ugandské ministerstvo 28. července oznámilo, že země je „oficiálně bez eboly“, avšak přenos v DRK pokračuje. Upozornění MZV ČR pro Ugandu bylo při ověření 2. září nadále veřejně dostupné bez obsahové změny; konec ugandského ohniska proto sám nemění české cestovní doporučení.

Aktuálně ověřené zdroje k 2. září: [WHO rychlé hodnocení rizika, verze 4, 20. srpna 2026](https://www.who.int/publications/m/item/who-rapid-risk-assessment-ebola-disease-caused-by-bundibugyo-virus--democratic-republic-of-the-congo-v4), [WHO: úplná zpráva z druhého jednání nouzového výboru, 28. srpna](https://www.who.int/news/item/28-08-2026-second-meeting-of-the-ihr-emergency-committee-on-the-epidemic-of-ebola-bundibugyo-virus-disease-in-the-democratic-republic-of-the-congo---meeting-report), [ECDC stránka k ohnisku, aktualizovaná 1. září](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) a [WHO denní epidemiologická aktualizace 20260901](https://www.who.int/emergencies/alert-and-response).

Další zdroje k českému a cestovnímu kontextu:
[iROZHLAS: řízený převoz ženy po návratu z Ugandy, 1. srpna](https://www.irozhlas.cz/zpravy-domov/zena-prijela-z-ugandy-je-u-ni-podezreni-na-vysoce-nebezpecnou-nakazu_2608011430_jho),
[iROZHLAS: ebola a další vysoce nebezpečné nákazy vyloučeny, 2. srpna](https://www.irozhlas.cz/zpravy-domov/u-zeny-ktera-byla-v-ugande-se-nebezpecna-nakaza-nepotvrdila-zustava-ale-dal-v_2608020912_zko),
[ministr zdravotnictví Adam Vojtěch: negativní laboratorní výsledek](https://x.com/adamvojtech86/status/2083807573719871638),
[Hygienická služba ČR: informace k českému podezření](https://x.com/Hygiena_cz/status/2083579045996875834),
...
[ČTK/Seznam Zprávy: propuštění z péče FN Bulovka](https://www.seznamzpravy.cz/clanek/domaci-zivot-v-cesku-fn-bulovka-propustila-lekare-z-usa-ktery-byl-v-kontaktu-s-ebolou-308279),
...
[Charité: propuštění berlínského pacienta](https://www.charite.de/en/service/press_reports/artikel/detail/patient_discharged_from_charites_special_isolation_unit),
[US CDC: navracející se cestovatelé](https://www.cdc.gov/ebola/situation-summary/returning-travelers.html),
...
[Uganda MoH: cestovatelé nepotřebují potvrzení Ebola-Free Certificate](https://evd-daily.health.go.ug/updates/travellers-do-not-require-an-ebola-free-certificate),
[SZÚ: český přehled](https://szu.gov.cz/temata-zdravi-a-bezpecnosti/a-z-infekce/e/ebola/ebola-kongo-uganda-2026/ebola-2026-3-6-2026/),
...
[MZV ČR: Uganda, při ověření 2. září označeno „Stále v platnosti: 2. 9. 2026“](https://mzv.gov.cz/jnp/cz/cestujeme/aktualni_doporuceni_a_varovani/uganda_vyskyt_eboly.html) a
[MZV ČR: Kongo (Kinshasa), při ověření 2. září označeno „Stále v platnosti: 2. 9. 2026“](https://mzv.gov.cz/jnp/cz/cestujeme/aktualni_doporuceni_a_varovani/konzska_demokraticka_republika.html). Úplný zdrojový inventář je na stránce [Zdroje a metodika](/dashboards/ebola-zdroje/).