---
title: "Ebola BDBV 2026 — Dezinformace"
origin: ai-assisted
description: "Sekce situačního reportu: Dezinformace. Zdroj: IMG AV ČR / UJEP."
...
<div class="d-flex flex-wrap gap-1 mb-4" role="navigation" aria-label="Sekce situačního reportu">
  ...
  <a href="/dashboards/ebola-dezinformace/" class="btn btn-sm btn-outline-secondary me-1 mb-1 active">Dezinformace</a>
...
Zdroj k novému tvrzení o profylaxi: [ALIMA / INRB / ANRS MIE: zahájení studie EBO-PEP, 14. července 2026](https://alima.ngo/actualites/virus-ebola-bundibugyo-lancement-essai-ebo-pep/).

Nové zdroje: [WHO AFRO: komunitní dialog a důvěra v Nyankunde, 3. září 2026](https://www.afro.who.int/countries/democratic-republic-of-congo/news/community-dialogue-building-trust-ebola-response-democratic-republic-congo), [UNICEF: květnový průzkum U-Report, publikováno 13. července 2026](https://www.unicef.org/drcongo/en/stories/young-community-volunteers-leading-fight-against-ebola), [US CDC: pacient nakažený v DRK, 10. července 2026](https://www.cdc.gov/media/releases/2026/cdc-ebola-outbreak-in-democratic-republic-of-congo-and-uganda.html), [německé BMG: Frankfurt, 13. července 2026](https://www.bundesgesundheitsministerium.de/service/begriffe-von-a-z/e/ebola) a [Oxfordská univerzita: studie fáze I s kandidátní vakcínou ChAdOx1 BDBV, 13. července 2026](https://www.ox.ac.uk/news/2026-07-13-worlds-first-phase-i-bundibugyo-ebolavirus-vaccine-trial-launched-by).

Hlavní zdroje: [Konrad-Adenauer-Stiftung: health disinformation playbook](https://www.kas.de/en/country-reports/detail/-/content/the-playbook-of-health-disinformation-and-the-ebola-outbreak-in-the-drc-and-uganda), [Gavi/VaccinesWork: boj s fámami v DRK](https://www.gavi.org/vaccineswork/where-fighting-ebola-means-fighting-rumours), [ActionAid: mýty a dezinformace v Ituri](https://actionaid.org/news/2026/1-3-people-ituri-believe-ebola-not-real-myths-and-misinformation-hamper-containment), [AFP Fact Check: neověřená léčebná tvrzení](https://factcheck.afp.com/doc.afp.com.B3JU6G3), [WHO denní epidemiologická aktualizace 20260903](https://www.who.int/emergencies/alert-and-response), [WHO AFRO report 16](https://www.afro.who.int/countries/uganda/publication/ebola-bundibugyo-virus-disease-outbreak-democratic-republic-congo-uganda-weekly-external-situation), [ECDC stránka k ohnisku, ověření 4. září 2026](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) a [úplný inventář zdrojů](/dashboards/ebola-zdroje/).