...
- verze webu / website version: v88
- revize kurace / curation review: 2026-09-25
- stav k datu posledního bodu / latest point data cut-off: 2026-09-22
- počet bodů / number of points: 109
...
Časová řada končí nejnovějším veřejným detailním SitRepem 131 s údaji k 22. září 2026. PDF je datováno 23. září a příloha byla na webu INSP zveřejněna 24. září. SitRepy 86–131 byly dohledány přes oficiální WordPress rozhraní INSP a každý řádek odkazuje přímo na příslušné PDF. Denní hodnoty se přebírají pouze tehdy, když je SitRep přímo uvádí; nejsou dopočítávány rozdílem kumulativních součtů.

The time series ends with the latest public detailed report, SitRep 131 with data as of 22 September 2026. The PDF is dated 23 September and the attachment was posted on the INSP website on 24 September. SitReps 86–131 were located through the official INSP WordPress interface, and each row links directly to its PDF. Daily values are used only when the SitRep states them directly; they are not reconstructed from differences between cumulative totals.
...
SitRepy 129–131 přímo hlásí za 20.–22. září dvojice 61/33, 40/27 a 47/20 případů/úmrtí. Denní úmrtí jsou součty 22 + 11, 14 + 13 a 13 + 7. SitRep 131 uvádí druhý potvrzený případ v Sud Ubangi, ale žádnou novou zdravotní zónu; sám o sobě neprokazuje místní přenos.

SitReps 129–131 directly report case/death pairs of 61/33, 40/27 and 47/20 for 20–22 September. Daily deaths sum 22 + 11, 14 + 13 and 13 + 7. SitRep 131 lists a second confirmed case in Sud Ubangi but no new health zone; it does not itself establish local transmission.
